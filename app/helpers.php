...
if (!function_exists('invalidFeedbackDIV')) {
    function invalidFeedbackDIV($field_name) {
        $errors = session()->get('errors');
        if ($errors && $errors->has($field_name)) {
            return '<div class="invalid-feedback">' . $errors->first($field_name) . '</div>';
        }
        return '';
    }
}
...
if (!function_exists('invalidsFeedbackDIV')) {
    function invalidsFeedbackDIV($field_name) {
        $errors = session()->get('errors');
        if ($errors && $errors->has($field_name)) {
            $allErrors = $errors->get($field_name);
            $errorMessages = '';
            foreach ($allErrors as $error) {
                $errorMessages .= '<div class="invalid-feedback d-block">' . $error . '</div>';
            }
