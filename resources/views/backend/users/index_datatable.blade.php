...
<link rel="stylesheet" href="{{ secure_asset('vendor/datatable/datatables.min.css') }}">

@endpush

@push ('after-scripts')
<!-- DataTables Core and Extensions -->
<script type="module" src="{{ secure_asset('vendor/datatable/datatables.min.js') }}"></script>
