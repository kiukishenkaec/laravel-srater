...
<meta property="og:image" content="{{ secure_asset(setting('meta_image')) }}" />
...
<meta name="twitter:image" content="{{ secure_asset(setting('meta_image')) }}">

<!--canonical link-->
<link type="text/plain" rel="author" href="{{secure_asset('humans.txt')}}" />
